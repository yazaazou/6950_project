...
def get_violin(df,col,y_label,saveStr):
...
def get_norm_skew(col,y_label,saveStr):
...
if __name__ == '__main__':
    ...
    get_violin(df,'meanTemp','Mean Temp (°C)','mean_monthly_dist')
    get_violin(df,'minTemp','Min. Temp (°C)','min_monthly_dist')
    get_violin(df,'maxTemp','Max. Temp (°C)','max_monthly_dist')
